...
namespace PartialClass
{
    public partial class Login : Form
    {
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            {
                textBox1.BackColor = Color.LightGreen; // Valid email
            }
            else
            {
                textBox1.BackColor = Color.LightPink; // Invalid email
            }
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            MessageBox.Show("Login successful (placeholder).", "Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
